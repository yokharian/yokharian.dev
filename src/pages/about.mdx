...
<div class="flex flex-col md:flex-row gap-8 items-start">
  ...
  <div class="flex-1 min-w-0">
    ...
    <p>[Check out my speaking history & topics](https://github.com/yokharian/speaking).</p>
  </div>
</div>
...
<div class="not-prose">
  <p class="text-sm text-gray-500 dark:text-gray-400 mt-8">Imprint: Sofia Escobedo, Siebensterngasse 15, 1070 Vienna, Austria</p>
</div>